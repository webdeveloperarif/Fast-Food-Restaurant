...
!(function (t, e) {
  ...
  (n.Instance = function () {
    ...
    var s = function (e) {
      t.extend(
        o,
        { classPrefix: "dialog", effects: { show: "fadeIn", hide: "fadeOut" } },
        e
      );
    };
    (this.createWidget = function (t, i) {
      ...
      (this.maybeLoadAssets = async function () {
        if (!!window.elementorFrontend?.utils?.assetsLoader)
          try {
    ...
    (n.Widget = function (e) {
      var i = this,
        ...
        l = function (e) {
          f(e) ||
            t(e.target).closest(r.widget).length ||
            (function (e) {
              return (
                !!o.hide.ignore && !!t(e.target).closest(o.hide.ignore).length
              );
            })(e) ||
            i.hide();
        },
        g = function () {
          t.each(o, function (t) {
            ...
            e &&
              ((e = e[1].charAt(0).toLowerCase() + e[1].slice(1)),
              i.on(e, this));
          });
        },
        f = function (t) {
        ...
        p = function () {
          var t = [r.window];
          r.iframe && t.push(jQuery(r.iframe[0].contentWindow)),
            t.forEach(function (t) {
              o.hide.onEscKeyPress && t.off("keyup", h),
                o.hide.onOutsideClick &&
                  t[0].removeEventListener("click", l, !0),
                o.hide.onOutsideContextMenu &&
                  t[0].removeEventListener("contextmenu", l, !0),
                o.position.autoRefresh && t.off("resize", i.refreshPosition);
            }),
            (o.hide.onClick || o.hide.onBackgroundClick) &&
              r.widget.off("click", u);
        };
      (this.addElement = function (e, n, i) {
        ...
        return (
          (i = i ? i + " " : ""),
          (i += o.classes.globalPrefix + "-" + a),
          (i += " " + o.classes.prefix + "-" + a),
          s.addClass(i),
          s
        );
      }),
        (this.destroy = function () {
          ...
          return (
            -1 !== e && i.parent.openDialogs.splice(e, 1),
            p(),
            r.widget.remove(),
            i.trigger("destroy"),
            i
        ...
        (this.hide = function () {
          ...
          return e[e.length - 1] === t
            ? (e.pop(),
              ...
              p(),
              o.preventScroll &&
                i.getElements("body").removeClass(o.classes.preventScroll),
              i.trigger("hide"),
              i)
            : void 0;
        }),
        (this.init = function (s, a) {
          if (!(s instanceof n.Instance))
            throw (
              "The " +
              i.widgetName +
          ...
          return (
            (i.parent = s),
            (d = c.concat(i.getClosureMethods())),
            t.each(d, function () {
              var t = i[this];
              i[this] = function () {
                t.apply(i, arguments);
            ...
            (function (n, s) {
              ...
              (o = {
                ...
                t.extend(!0, o, i.getDefaultSettings(), s),
                g();
            })(s, a),
            (function () {
              if (
                (i.addElement("widget"),
                i.addElement("header"),
                i.addElement("message"),
                i.addElement("window", window),
                i.addElement("body", document.body),
                i.addElement("container", o.container),
                o.iframe && i.addElement("iframe", o.iframe),
                o.closeButton)
              ) {
                o.closeButtonClass &&
                  (o.closeButtonOptions.iconClass = o.closeButtonClass);
                const e = t("<a>", o.closeButtonOptions.attributes),
                  n = t(o.closeButtonOptions.iconElement).addClass(
                    o.closeButtonOptions.iconClass
                  );
              ...
              t.each(i.types, function () {
                ...
                n.push(i.getSettings("className")),
                r.widget
                  .addClass(n.join(" "))
                  .attr({ "aria-modal": !0, role: "document", tabindex: 0 });
            })(),
            i.buildWidget(),
            i.attachEvents(),
            i.trigger("ready"),
                    ...
                    1 === o.length &&
                      ...
                      o.forEach(function (t, o) {
                        var r = t.replace(e, function (t) {
                          return (
                            (t = +t || 0),
                            (t += o ? n.top - i.scrollY : n.left - i.scrollX) >=
                              0 && (t = "+" + t),
                            t
                          );
                        });
        ...
        (this.setSettings = function (e, n) {
          return (
            jQuery.isPlainObject(n) ? t.extend(!0, o[e], n) : (o[e] = n), i
          );
        }),
        (this.show = function () {
          var t;
          clearTimeout(a),
            r.widget.appendTo(r.container).hide(),
            d("show", arguments),
            i.refreshPosition(),
            o.hide.auto && (a = setTimeout(i.hide, o.hide.autoDelay)),
            (t = [r.window]),
            r.iframe && t.push(jQuery(r.iframe[0].contentWindow)),
            t.forEach(function (t) {
              o.hide.onEscKeyPress && t.on("keyup", h),
                o.hide.onOutsideClick && t[0].addEventListener("click", l, !0),
                o.hide.onOutsideContextMenu &&
                  t[0].addEventListener("contextmenu", l, !0),
                o.position.autoRefresh && t.on("resize", i.refreshPosition);
            }),
            (o.hide.onClick || o.hide.onBackgroundClick) &&
              r.widget.on("click", u),
            o.preventScroll &&
              i.getElements("body").addClass(o.classes.preventScroll),
            i.trigger("show");
    ...
    (n.Widget.prototype.types = []),
    (n.Widget.prototype.buildWidget = function () {
    ...
    (n.Widget.prototype.attachEvents = function () {
      ...
      t.getSettings("closeButton") &&
        t.getElements("closeButton").on("click", function (e) {
    ...
    (n.Widget.prototype.onHide = function () {}),
    (n.Widget.prototype.onShow = function () {}),
    (n.Widget.prototype.onInit = function () {}),
    (n.Widget.prototype.onReady = function () {}),
    (n.widgetsTypes.simple = n.Widget),
    n.addWidgetType("buttons", {
      ...
      activeKeyDown: function (t) {
        if (this.focusedButton) {
          if (9 === t.which) {
            t.preventDefault();
            var e,
              n = this.focusedButton.index();
            t.shiftKey
              ? (e = n - 1) < 0 && (e = this.buttons.length - 1)
              : (e = n + 1) >= this.buttons.length && (e = 0),
              (this.focusedButton = this.buttons[e].trigger("focus"));
          }
        }
      },
      addButton: function (e) {
        ...
        n.buttons.push(r);
        var a = function () {
          i.hide.onButtonClick && n.hide(),
            "function" == typeof e.callback && e.callback.call(this, n);
        };
        return (
          r.on("click", a),
          e.hotKey && (this.hotKeys[e.hotKey] = a),
          this.getElements("buttonsWrapper").append(r),
          e.focus && (this.focusedButton = r),
          n
        );
      },
      ...
      onShow: function () {
        this.bindHotKeys(),
          ...
          this.focusedButton && this.focusedButton.trigger("focus");
      },
    ...
    n.addWidgetType(
      "lightbox",
      n.getWidgetType("buttons").extend("lightbox", {
        getDefaultSettings: function () {
          var e = n
        ...
        buildWidget: function () {
          n.getWidgetType("buttons").prototype.buildWidget.apply(
            this,
            arguments
          );
    ...
    n.addWidgetType(
      "confirm",
      n.getWidgetType("lightbox").extend("confirm", {
        onReady: function () {
    ...
    n.addWidgetType(
      "alert",
      n.getWidgetType("lightbox").extend("alert", {
        onReady: function () {
          n.getWidgetType("lightbox").prototype.onReady.apply(this, arguments);
          var t = this.getSettings("strings");
          this.addButton({
