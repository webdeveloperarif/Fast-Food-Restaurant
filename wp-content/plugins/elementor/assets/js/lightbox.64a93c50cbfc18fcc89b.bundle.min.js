    ...
    667: (e, t, i) => {
      ...
      class IconsManager {
        ...
        createSvgElement(e, t) {
          ...
          return this.createSvgIconElement({ iconName: o, iconSelector: l });
        }
        createSvgNode(e, t) {
          let { props: i = {}, attrs: n = {} } = t;
          const s = document.createElementNS("http://www.w3.org/2000/svg", e);
          return (
            Object.keys(i).map((e) => (s[e] = i[e])),
            Object.keys(n).map((e) => s.setAttributeNS(null, e, n[e])),
            s
          );
        }
        createSvgIconElement(e) {
          let { iconName: t, iconSelector: i } = e;
          return this.createSvgNode("svg", {
            props: { innerHTML: '<use xlink:href="' + i + '" />' },
            attrs: { class: "e-font-icon-svg e-" + t },
          });
        }
        ...
        createSymbolElement(e) {
          let { id: t, path: i, width: n, height: s } = e;
          return this.createSvgNode("symbol", {
            props: { innerHTML: '<path d="' + i + '"></path>', id: t },
            attrs: { viewBox: "0 0 " + n + " " + s },
          });
        }
      }
      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        initModal() {
          ...
          this.isFontIconSvgExperiment
            ? (t.iconElement = o.close.element)
            : (t.iconClass = "eicon-close");
          const i = (e.exports.modal = elementorFrontend
            .getDialogsManager()
        ...
        showModal(e) {
          ...
          const n = t.getModal();
          switch (
            (n.setID(t.getSettings("modalOptions.id")),
            (n.onShow = function () {
            ...
            (n.onHide = function () {
              DialogsManager.getWidgetType("lightbox").prototype.onHide.apply(
                ...
                n.getElements("message").removeClass("animated"),
                s.default.isFullscreen && t.deactivateFullscreen(),
                t.unbindHotKeys();
            }),
            e.type)
          ) {
        ...
        setVideoContent(e) {
          ...
          if ("hosted" === e.videoType) {
            const n = t.extend({ src: e.url, autoplay: "" }, e.videoParams);
            i = t("<video>", n);
          } else {
            let n;
            if (-1 !== e.url.indexOf("vimeo.com"))
              n = elementorFrontend.utils.vimeo;
            else {
              if (
                !e.url.match(
            ...
            (i = t("<iframe>", { allowfullscreen: 1 })),
              "yes" === e.autoplay
                ? (i.attr("allow", "autoplay"),
                  i.attr("src", n.getAutoplayURL(e.url)))
                : i.attr("src", e.url);
          }
          const n = this.getSettings("classes"),
            s = this.getRatioDictionry(
              this.getSettings("modalOptions.videoAspectRatio")
            ),
            o = t("<div>", { class: `${n.videoContainer} ${n.preventClose}` }),
            l = t("<div>", {
              class: `${n.videoWrapper} elementor-video-${this.getRatioType(
                s
              )}`,
          ...
          a.onHide = function () {
            r(),
              (this.$buttons = jQuery()),
              (this.focusedButton = null),
              a.getElements("message").removeClass("elementor-video-wrapper");
          };
        },
        getRatioDictionry: (e) =>
          ({
        ...
        getShareLinks() {
          const { i18n: e } = elementorFrontend.config,
            t = {
              facebook: { label: e.shareOnFacebook, iconElement: o.facebook },
              twitter: { label: e.shareOnTwitter, iconElement: o.twitter },
              pinterest: { label: e.pinIt, iconElement: o.pinterest },
            },
            i = jQuery,
            n = this.getSettings("classes"),
            s = this.getSettings("selectors"),
            l = i("<div>", { class: n.slideshow.shareLinks }),
            a = this.getSlide("active"),
            r = a.find(s.image),
            d = a.data("elementor-slideshow-video");
          let h;
          if (
            ((h = d || r.attr("src")),
            i.each(t, (e, t) => {
              const n = t.label,
                s = i("<a>", {
                  href: this.createShareLink(
                    e,
                    h,
                    a.attr("data-e-action-hash")
                  ),
                  target: "_blank",
                }).text(n),
                o = this.isFontIconSvgExperiment
                  ? i(t.iconElement.element)
                  : i("<i>", { class: "eicon-" + e, "aria-hidden": "true" });
              s.prepend(o), l.append(s);
            }),
            !d)
          ) {
            const t = this.isFontIconSvgExperiment
              ? i(o.downloadBold.element)
              : i("<i>", { class: "eicon-download-bold" });
        ...
        getSlideshowHeader() {
          ...
          if (i || n || s || l) {
            if (
              ...
              const i = this.isFontIconSvgExperiment
                ? o.shareArrow.element
                : "<i>";
              d.$iconShare = t(i, {
                class: r.iconShare,
                role: "button",
              ...
              n.on("click", (e) => {
                ...
                (d.$shareMenu = t("<div>", { class: r.shareMenu }).append(n)),
                d.$iconShare
                  .add(d.$shareMenu)
            ...
            if (s) {
              const i = this.isFontIconSvgExperiment
                ...
                l = { ...s };
              this.isFontIconSvgExperiment || (l.class = r.iconZoomIn),
                (d.$iconZoom = t(i).attr(l).on("click", this.toggleZoomMode)),
                n.push(d.$iconZoom),
                this.isFontIconSvgExperiment &&
                  ((d.$iconZoomOut = t(o.zoomOutBold.element)
                    .attr(s)
                    .addClass(a.hidden)
            ...
            if (n) {
              const i = this.isFontIconSvgExperiment
                ...
                l = { ...s };
              this.isFontIconSvgExperiment || (l.class = r.iconExpand),
                (d.$iconExpand = t(i)
                ...
                n.push(d.$iconExpand),
                this.isFontIconSvgExperiment &&
                  ((d.$iconMinimize = t(o.frameMinimize.element)
                    .attr(s)
                    .addClass(a.hidden)
                    .on("click", this.toggleFullscreen)),
            ...
            return (
              i &&
                ((d.$counter = t("<span>", { class: r.counter })),
        ...
        toggleFullscreen() {
          s.default.isFullscreen
            ...
            : s.default.isEnabled && this.activateFullscreen();
        },
        toggleZoomMode() {
        ...
        activateZoom() {
          ...
          e.zoom.in(),
            ...
            (e.allowSlidePrev = !1),
            (e.allowTouchMove = !1),
            t.$container.addClass(i.slideshow.zoomMode),
            this.isFontIconSvgExperiment
              ? (t.$iconZoom.addClass(i.hidden).attr("aria-checked", "false"),
                t.$iconZoomOut
                  .removeClass(i.hidden)
                  .attr("aria-checked", "true"))
              : t.$iconZoom
                  .removeClass(i.slideshow.iconZoomIn)
                  .addClass(i.slideshow.iconZoomOut);
        },
        deactivateZoom() {
          const e = this.swiper,
            t = this.elements,
          ...
          e.zoom.out(),
            ...
            (e.allowSlidePrev = !0),
            (e.allowTouchMove = !0),
            t.$container.removeClass(i.slideshow.zoomMode),
            this.isFontIconSvgExperiment
              ? (t.$iconZoom.removeClass(i.hidden).attr("aria-checked", "true"),
                t.$iconZoomOut.addClass(i.hidden).attr("aria-checked", "false"))
              : t.$iconZoom
                  .removeClass(i.slideshow.iconZoomOut)
                  .addClass(i.slideshow.iconZoomIn);
        },
        getSlideshowFooter() {
          const e = jQuery,
            ...
            s = e("<div>", { class: t.slideshow.description });
        ...
        setSlideshowContent(e) {
          const { i18n: t } = elementorFrontend.config,
            i = jQuery,
            n = 1 === e.slides.length,
            s = "" !== elementorFrontend.getKitSettings("lightbox_title_src"),
            l =
              "" !==
            ...
            d = r.slideshow,
            h = i("<div>", { class: d.container }),
            c = i("<div>", { class: d.slidesWrapper });
          let m, g;
          if (
            (e.slides.forEach((e) => {
              let n = d.slide + " " + r.item;
              e.video && (n += " " + r.video);
              const s = i("<div>", { class: n });
              if (e.video) {
                s.attr("data-elementor-slideshow-video", e.video);
                const n = this.isFontIconSvgExperiment
                    ? o.loading.element
                    : "<i>",
                  l = i("<div>", { class: r.playButton }).html(
                    i(n)
                      .attr("aria-label", t.playVideo)
                      .addClass(r.playButtonIcon)
                  );
                s.append(l);
              } else {
                const t = i("<div>", { class: "swiper-zoom-container" }),
                  n = i('<div class="swiper-lazy-preloader"></div>'),
                  o = {
                    "data-src": e.image,
                    class: r.image + " " + r.preventClose + " swiper-lazy",
                  };
                e.title && ((o["data-title"] = e.title), (o.alt = e.title)),
                  e.description &&
                    ((o["data-description"] = e.description),
                    (o.alt += " - " + e.description));
                const l = i("<img>", o);
            ...
            (this.elements.$container = h),
            (this.elements.$header = this.getSlideshowHeader()),
            h.prepend(this.elements.$header).append(c),
            !n)
          ) {
            const e = this.isFontIconSvgExperiment
                ? i(o.chevronLeft.element)
                : i("<i>", { class: d.prevButtonIcon, "aria-hidden": "true" }),
              n = this.isFontIconSvgExperiment
                ? i(o.chevronRight.element)
                : i("<i>", { class: d.nextButtonIcon, "aria-hidden": "true" }),
              s = i("<span>", { class: "screen-reader-text" }).html(t.previous),
              l = i("<span>", { class: "screen-reader-text" }).html(t.next);
            (m = i("<div>", {
              ...
              h.append(g, m),
              (this.$buttons = this.$buttons.add(g).add(m));
          }
          a &&
            ((this.elements.$footer = this.getSlideshowFooter()),
            h.append(this.elements.$footer)),
            this.setSettings("hideUiTimeout", ""),
            h.on("click mousemove keypress", this.showLightboxUi);
          ...
          p.onShow = async () => {
            ...
            n || (t.navigation = { prevEl: m[0], nextEl: g[0] }),
              e.swiper && i.extend(t, e.swiper);
            const s = elementorFrontend.utils.swiper;
            (this.swiper = await new s(h, t)),
              h.data("swiper", this.swiper),
              this.playSlideVideo(),
              a && this.updateFooterText(),
              this.bindHotKeys(),
          ...
          if (9 === e.which) {
            ...
            t.each((e) => {
              ...
              if (jQuery(o).is(":focus"))
                return (i = o), (n = 0 === e), (s = t.length - 1 === e), !1;
            }),
              e.shiftKey
                ? n && (e.preventDefault(), t.last().trigger("focus"))
                : (!s && i) || (e.preventDefault(), t.first().trigger("focus"));
          }
        },
        getSlide(e) {
