!(function (d) {
  ...
  var P = {
      ...
      getOptions: function (e) {
        var o = void 0 !== e.data("options") ? e.data("options") : {},
          ...
          b = void 0 !== o.parallax && "yes" === o.parallax,
          q =
            (!1 !== u && 5e3 !== q
              ? (u = { delay: q, disableOnInteraction: !1 })
              : !1 !== u && (u = { disableOnInteraction: !1 }),
            void 0 !== o.slidesPerView1680 && "" !== o.slidesPerView1680
              ? parseInt(o.slidesPerView1680, 10) + n
              : "auto" === o.slidesPerView
              ? "auto"
              : 5 + n),
          C =
        ...
        return Object.assign(
          {
            ...
            parallax: b,
            breakpoints: {
              0: { slidesPerView: S, spaceBetween: a },
              481: { slidesPerView: x, spaceBetween: a },
              681: { slidesPerView: I, spaceBetween: r },
              769: { slidesPerView: A, spaceBetween: r },
              1025: { slidesPerView: y },
              1367: { slidesPerView: C },
              1441: { slidesPerView: q },
              1681: { slidesPerView: s },
            },
          },
          P.getSliderDatas(e)
        );
        ...
        }),
      {
        init: function () {
          if (
            ...
            for (const n in fsLightboxInstances)
              fsLightboxInstances[n].props.onInit = function () {
                ...
                (o[0].innerHTML = qodefQiAddonsGlobal.vars.iconArrowLeft),
                  (t[0].innerHTML = qodefQiAddonsGlobal.vars.iconArrowRight),
                  (e[0].innerHTML = qodefQiAddonsGlobal.vars.iconClose);
              };
          }
        },
      }),
    ...
    i =
      ((qodefAddonsCore.qodefSwiperElementorCheck = t),
      {
        init: function () {
          i.iOSCheck() &&
            (qodefAddonsCore.body.removeClass(
              "qodef-qi--touch qodef-qi--no-touch"
            ),
            qodefAddonsCore.body.addClass("qodef-qi--touch"));
        },
        iOSCheck: function () {
          return (
            [
  ...
  qodefAddonsCore.qodefIOSTouchClass = i;
})(jQuery),
  (function (i) {
    "use strict";
    ...
    var e = {
      ...
      initItem: function (n) {
        n.find(".qodef-e-word-holder").each(function () {
          for (var e = i(this).text(), o = e.length, t = "", n = 0; n < o; n++)
            t += '<span class="qodef-e-character">' + e.charAt(n) + "</span>";
          i(this).html(t);
        }),
  ...
  (function (d) {
    ...
    var e = {
      init: function () {
        (this.holder = d(".qodef-qi-cards-gallery")),
          this.holder.length &&
            this.holder.each(function () {
              e.initItem(d(this));
            });
        ...
        d(n.get().reverse()).each(function () {
          ...
          e.on("click", function () {
            if (!n.last().is(e))
              return (
                "both" === i &&
                  (t = e.index() % 2 ? "0 0 0 20%" : "0 0 0 -20%"),
                e
                  .addClass("qodef-out")
                  .animate({ margin: t }, 200, "swing", function () {
                    e.detach(),
                      e
                        .insertAfter(n.last())
          ...
          C.forEach(function (e, t) {
            ...
            e &&
              ...
              (n.onload = function () {
                ...
                (d[t] = o), (r[t] = o), new Chart(e, A);
              }));
          }),
          y || ((e = i.find("canvas")), new Chart(e, A));
      },
    };
  ...
  (function (t) {
    ...
    var e = {
      ...
      initItem: function (e) {
        var o = e.closest(".elementor-element");
      ...
      initSwiperReinit: function (e) {
        var o = e.find("> .qodef-qi-swiper-container .swiper-slide-active"),
          ...
          i =
            ...
            (o.autoplay = "false"),
            (t = n[0].swiper.params.autoplay.enabled),
      ...
      initSwiperReinit: function (e) {
        var o,
          ...
          s =
            ...
            d[0].swiper.destroy(),
            r[0].swiper.destroy(),
            new Swiper(d[0], Object.assign(t))),
  ...
  (function (e) {
    ...
    var o,
      t = qodefAddonsCore.windowHeight,
      s =
        (e(document).ready(function () {
          s.init();
        }),
        e(window).resize(function () {
          clearTimeout(o),
            (o = setTimeout(() => {
              100 < Math.abs(qodefAddonsCore.windowHeight - t) && s.init(),
                (t = qodefAddonsCore.windowHeight);
            }, 200));
        }),
        {
      ...
      initItem: function (s) {
        qodefAddonsCore.shortcodes.qi_addons_for_elementor_button.qodefButton.init(
          ...
          e("body").on("added_to_cart", function () {
            var e = s.find(".added_to_cart:not(.qodef-qi-button)");
            if (e.length) {
              for (
                var o = e.siblings(".add_to_cart_button"),
                  t = [
                    "button",
                    "product_type_simple",
                    "add_to_cart_button",
                  ...
                  n = t.length,
                  i = o.attr("class"),
                  d = o.find(".qodef-m-border"),
                  r = o.find(".qodef-m-inner-border"),
                  o = o.find(".qodef-m-icon"),
                  a = 0;
                a < n;
                a++
              )
                i = i.replace(t[a], "");
              e.addClass(i),
                e.wrapInner('<span class="qodef-m-text">'),
                d.length && ((d = d.clone()), e.append(d)),
                o.length && ((d = o.clone()), e.append(d)),
                r.length && ((o = r.clone()), e.append(o));
            }
          });
      },
    };
