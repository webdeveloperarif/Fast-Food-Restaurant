      ...
      if (isEditMode) {
        for (var key in qodefAddonsCore.shortcodes) {
          for (var keyChild in qodefAddonsCore.shortcodes[key]) {
            qodefAddonsElementor.reInitShortcode(key, keyChild);
          }
        }
      }
    },
    reInitShortcode: function (key, keyChild) {
      elementorFrontend.hooks.addAction(
        ...
        function (e) {
          ...
          if (
            typeof qodefAddonsCore.shortcodes[key][keyChild] === "undefined"
          ) {
            console.log(keyChild);
          } else if (
            typeof qodefAddonsCore.shortcodes[key][keyChild].initSlider ===
            "function"
          ) {
            ...
            typeof qodefAddonsCore.shortcodes[key][keyChild].initItem ===
              "function" &&
            e.find(".qodef-shortcode").length
          ) {
            qodefAddonsCore.shortcodes[key][keyChild].initItem(
              e.find(".qodef-shortcode")
            );
          } else {
            ...
            qodeWidgetsPromoHandler = {
              ...
              onMouseDown: function () {
                ...
                elementor.promotion.showDialog({
                  ...
                  title: sprintf(
                    wp.i18n.__("%s Widget", "qi-addons-for-elementor"),
                    title
                  ),
                  content: content,
                  position: {
