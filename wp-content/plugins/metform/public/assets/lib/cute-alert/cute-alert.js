const cuteAlert = ({
    ...
    new Promise((e) => {
      ...
      let b = "";
      for (let e of v)
        e.src.includes("cute-alert.js") &&
          (b = e.src.substring(0, e.src.lastIndexOf("/")));
      ...
      const y = `\n    <div class="alert-wrapper">\n      <div class="alert-frame">\n        ${
        o === undefined
          ? '<div class="alert-header ' + t + '-bg">'
          : '<div class="alert-header-base">'
      }\n          <span class="alert-close ${
        "circle" === d ? "alert-close-circle" : "alert-close-default"
      }">X</span>\n          ${
        o === undefined
          ? '<img class="alert-img" src="' + b + "/img/" + t + '.svg" />'
          : '<div class="custom-img-wrapper">' + o + "</div>"
  ...
  cuteToast = ({
    ...
    new Promise((c) => {
      ...
      for (let e of l)
        e.src.includes("cute-alert.js") &&
          (i = e.src.substring(0, e.src.lastIndexOf("/")));
      ...
      if ((o.length > 0 && navigator.vibrate(o), null !== a)) {
        new Audio(a).play();
      }
      setTimeout(() => {
        b.remove(), c();
